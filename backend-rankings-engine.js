...
// Archetype detection — canonical performance keys (matches archetypes-dict.js)
const ARCHETYPES = [
...
// Archetype metadata — canonical cosmetic display data (mirrors archetype-avatars.js — keep in sync)
